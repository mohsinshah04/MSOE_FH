...
const aboutUs = () => {
  return (
    <div className="teambox">
      <div> <p/><span className="aboutTitle">About Us</span><p/></div>
      <div><p/>
        ...
        the hybrid category in 2013. Our first hybrid vehicle was the MP3, followed by the MP4 then the MP5 and the current
         ...
         their technical skills, take on leadership and administrative roles, or both.<br/><br/>
      ...
      skills in automotive design, engineering, and teamwork. The competition aims to advance the development and application
       ...
       project management, and teamwork. The competition serves as a practical application of classroom knowledge.<br/><br/>
