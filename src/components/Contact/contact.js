...
const Contact = () => {
    ...
    return (
        <section id="contact">
                ...
                <span className="contactDesc">Please fill out the form below to contact us with any questions.- Form is currently down. Please email us at "mozee.motorsports@msoe.edu"</span>
